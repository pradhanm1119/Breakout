...
//        [self initializeBlocks];
        UIAlertView *alertViewMessage = [[UIAlertView alloc] initWithTitle:@"Game Over" message:@"cool story bro" delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
